 ...
 */
public abstract class Hilt_NoteListingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NoteListingFragment() {
    super();
  }

  Hilt_NoteListingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoteListingFragment_GeneratedInjector) this.generatedComponent()).injectNoteListingFragment(UnsafeCasts.<NoteListingFragment>unsafeCast(this));
    }
  }
